...
<body>
  <h4 class="p-4">Edit Book</h4>
  <form   class="my-2 card w-100  " id="task" name="task" enctype="multipart/form-data" action="script.php" method="POST">
  ...
  <input type="hidden" id="task-id" name="id" value="<?php echo "$id"; ?>">
    ...
    <div class="modal-footer">
      ...
      <button type="submit" class="btn btn-primary m-2" name="update" id="send">update</button>
    </div>
  </form>
  </div>
  </div>
